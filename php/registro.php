...
<body>
    <main class="form-signin w-75 m-auto container">
        ...
        <form class="text-body" action="../check/check.php?tipo=signin" method="post" onsubmit="validarSign(event)">
            <div class="form-floating">
                <input type="text" class="form-control" id="usuario" name="usuario" placeholder="pepito">
